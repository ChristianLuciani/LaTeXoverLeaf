...
\Ovalbox{
\begin{tikzcd}
\ovalbox{$\xi_1$}\arrow[bend left]{r}{f_{11}}   & \ovalbox{$\xi_1$}\arrow[bend left]{d}{f_{12}}\\&\ovalbox{$\xi_2$} \arrow[bend right]{d}[swap]{f_{23}}\\& \ovalbox{$\xi_3$}	\\
\Gamma_3
\end{tikzcd}	
}
\begin{tikzcd}
.\arrow[bend left]{r}{\Gamma_{23}}&.
\end{tikzcd}
...
\Ovalbox{
	\begin{tikzcd}
		...
		&\ovalbox{$\xi_4$}\\
		\ovalbox{$\xi_5$} \arrow[bend left]{rd}{f_{56}}&\\
